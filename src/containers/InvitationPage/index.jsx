...
const InvitationPage = () => {
  ...
  const wording = '5865078355';
  const giftAddress = 'Komp. Marinir Blok P1 NO 3 RT 05/06, Pancoran Mas, Depok';
  ...
  const addEvent = () => {
    ...
    gapi.load('client:auth2', () => {
      ...
      .then(() => {
        var event = {
          'summary': 'Braja & Ulfa Wedding Day',
  ...
  }, [Toast, confirmationErrorMessage, dispatch])
  ...
  const goToMaps = () => {
    window.open('https://maps.app.goo.gl/mn7nxNV57ocy5eoDA', '_blank');
  };
        ...
        <Fade delay={2000} duration={3000}>
          <div className={classes.headerAnimation}>
            <div className={classes.headerTitle}>
              {/* <p className={classes.titleTop}>Braja</p>
              <p className={classes.titleMid}>&</p>
              <p className={classes.titleBottom}>Ulfa</p> */}
            </div>
          </div>
        </Fade>
  ...
  const IosGenerateHeader = () => {
    return (
      <div className={classes.headerIos}>
        <Fade delay={2000} duration={3000}>
          <div className={classes.headerAnimationIos}>
            <div className={classes.headerTitleIos}>
              {/* <p className={classes.titleTop}>Braja</p>
              <p className={classes.titleMid}>&</p>
              <p className={classes.titleBottom}>Ulfa</p> */}
            </div>
        ...
        <div className={classes.countdownIos}>
          {timerComponents.length && timerComponents}
        </div>
      </div >
    );
        ...
        <div className={classes.profileWrapper}>
          <Fade left duration={3000}>
            <div className={classes.card}>
              ...
              <div className={classes.profileInfo}>
                <p className={classes.bridess}>Ulfa Rianti</p>
                <p className={classes.parents}>Putri Kedua dari{width === 'lg' && <br />} Bapak H. Yumairi &<br />Ibu Hj. Yanti Mala</p>
              </div>
            </div>
          </Fade>
          <Fade right duration={3000}>
            <div className={classes.card}>
              ...
              <div className={classes.profileInfo}>
                <p className={classes.bridess}>Braja Sifa Satyaputra</p>
                <p className={classes.parents}>Putra Kedua dari{width === 'lg' && <br />} Bapak Yayat S. Soelaeman &<br />Ibu Nani Maryani Salani</p>
              </div>
            </div>
          </Fade>
        </div>
        ...
        <Fade delay={1000} duration={4000}>
          ...
          <div className={classes.details}>
            ...
            <div className={classes.locationWraper}>
              ...
              <p>
                KOMP. MARINIR BLOK P1 NO 3 RT 05/06 PANCORAN MAS, DEPOK
              </p>
            </div>
          ...
          <div className={`${classes.giftInfoWraper} ${isShowGift ? classes.showGift : classes.hideGift} ${closeGift ? classes.closeGift : ''}`}>
            ...
            <div className={classes.infoWrapper}>
              ...
              <p className={classes.infoDetail}>
                Nama : Ulfa  Rianti <br />
                Alamat : Komp. Marinir Blok P1 NO 3 RT 05/06<br />Pancoran Mas, Depok
              </p>
              <div className={classes.copyWraper}>
  ...
  const generateInvitation = () => {
    return (
      <div className={classes.invitationContainer}>
        {!isIOS ? generateHeader() : IosGenerateHeader()}
        {/* {generateStory()}
        {generateSecondStory()} */}
